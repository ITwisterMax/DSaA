...
//Рисование дерева (Y - расстояние от верха до уровня, X1 и X2 - расстояния слева и справа)
...
begin
  ...
  //Прошивка
  GoFlash(NowTree, bmp);
  if (NowTree^.Left = nil) and (NowTree^.Right = nil) then ShowMessage('В дереве всего один элемент...');
